# Google Analytics
Follow these steps to configure Google Analytics for Metrix.
...
1. Click **Create Credentials** → **OAuth client ID**.
    ...
    1. Under the **Authorized redirect URIs**, click **Add URI** and enter the value from the **Redirect URI** field in Metrix.
    1. Then click the **Create** button.
1. Once created, a popup will appear with your OAuth credentials. Copy the **Client ID** and **Client Secret** values and paste into the fields in Metrix.
